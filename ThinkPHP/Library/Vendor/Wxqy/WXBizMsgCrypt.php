...
// include_once "../../Org/Wxqy/sha1.php";
// include_once "../../Org/Wxqy/xmlparse.php";
// include_once "../../Org/Wxqy/pkcs7Encoder.php";
// include_once "../../Org/Wxqy/errorCode.php";

vendor( 'Wxqy.sha1' );
vendor( 'Wxqy.xmlparse' );
vendor( 'Wxqy.pkcs7Encoder' );
vendor( 'Wxqy.errorCode' );
...
class WXBizMsgCrypt
{
	private $m_sToken = 'qyhd';
	private $m_sEncodingAesKey = '6ajFZ4mrxnyMbeYSht9qvEPmeWH3PTDvaMRnPS2E2n7';
	private $m_sCorpid = 'wx1c40df09d2c90926';
	...
	{
		$token and $this->m_sToken = $token;
		$encodingAesKey and $this->m_sEncodingAesKey = $encodingAesKey;
		$Corpid and $this->m_sCorpid = $Corpid;
	}
